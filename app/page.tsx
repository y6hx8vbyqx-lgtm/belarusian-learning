...
const APP_VERSION = "v0.9.1-module1-10-lessons";
...
const lessons: Lesson[] = [
    ...
    tasks: [
      {
        ...
        theoryRu:
          "Добры дзень — нейтральное приветствие. Прывітанне — неформальное. Да пабачэння — нейтральное прощание. На вопрос «Як справы?» можно ответить «Добра».",
        theoryBe:
          "Добры дзень — нейтральнае вітанне. Прывітанне — нефармальнае. Да пабачэння — нейтральнае развітанне. На пытанне «Як справы?» можна адказаць «Добра».",
      },
    ...
    tasks: [
      {
        ...
        titleRu: "Местоимения",
        titleBe: "Займеннікі",
        theoryRu: "Он — ён, она — яна, они — яны. Это частая зона ошибок для русскоязычных.",
        theoryBe: "Он — ён, она — яна, они — яны. Гэта частая зона памылак для рускамоўных.",
      },
    ...
    tasks: [
      {
        ...
        titleRu: "Я студент",
        titleBe: "Я студэнт",
        theoryRu: "По-белорусски можно сказать: Я студэнт. Я лекар. Я праграміст. Связка «есть» не нужна.",
        theoryBe: "Па-беларуску можна сказаць: Я студэнт. Я лекар. Я праграміст. Звязка «ёсць» не патрэбная.",
      },
  ...
  },
  {
    ...
    tasks: [
      {
        type: "theory",
        titleRu: "Я из Беларуси",
        titleBe: "Я з Беларусі",
        theoryRu: "По-белорусски: Я з Беларусі. Я з Мінска. Конструкция: з + место.",
        theoryBe: "Па-беларуску: Я з Беларусі. Я з Мінска. Канструкцыя: з + месца.",
      },
      { type: "translate", titleRu: "Выбери перевод", titleBe: "Выберы пераклад", word: { be: "Расія", ru: "Россия" } },
      { type: "audio", titleRu: "Послушай", titleBe: "Паслухай", word: { be: "Мінск", ru: "Минск" } },
      { type: "trueFalse", titleRu: "Проверь пару", titleBe: "Правер пару", word: { be: "Польшча", ru: "Польша" } },
      { type: "fill", titleRu: "Вставь слово", titleBe: "Устаў слова", word: { be: "Беларусі", ru: "Беларуси" }, sentenceBe: "Я з ____.", sentenceRu: "Я из Беларуси." },
      { type: "build", titleRu: "Собери предложение", titleBe: "Збяры сказ", sentenceBe: "Я з Мінска", sentenceRu: "Я из Минска", buildWords: ["Мінска", "з", "Я"] },
      { type: "finish", titleRu: "Урок завершён", titleBe: "Урок завершаны" },
    ],
  },
  {
    ...
    tasks: [
      {
        ...
        theoryRu: "Хто? — кто? Што? — что? Дзе? — где? Адкуль? — откуда? Як? — как?",
        theoryBe: "Хто? — кто? Што? — что? Дзе? — где? Адкуль? — откуда? Як? — как?",
      },
    ...
    tasks: [
      {
        ...
        theoryRu: "Сначала учим базовые формы: я жыву, я працую, я вучуся, я чытаю.",
        theoryBe: "Спачатку вучым базавыя формы: я жыву, я працую, я вучуся, я чытаю.",
      },
  ...
  },
  {
    ...
    words: [
      ...
      { be: "Як цябе завуць?", ru: "Как тебя зовут?" },
      { be: "Адкуль ты?", ru: "Откуда ты?" },
      { be: "Кім ты працуеш?", ru: "Кем ты работаешь?" },
      { be: "Да сустрэчы", ru: "До встречи" },
      { be: "Вельмі прыемна", ru: "Очень приятно" },
    ],
    tasks: [
      {
        type: "theory",
        ...
        theoryRu:
          "Теперь соединяем приветствие, имя, страну и профессию: Прывітанне! Мяне завуць Аляксей. Я з Расіі. Я праграміст.",
        theoryBe:
          "Цяпер злучаем вітанне, імя, краіну і прафесію: Прывітанне! Мяне завуць Аляксей. Я з Расіі. Я праграміст.",
      },
      ...
      { type: "trueFalse", titleRu: "Проверь пару", titleBe: "Правер пару", word: { be: "Я з Беларусі", ru: "Я из Беларуси" } },
      ...
      { type: "build", titleRu: "Собери предложение", titleBe: "Збяры сказ", sentenceBe: "Я праграміст", sentenceRu: "Я программист", buildWords: ["праграміст", "Я", "Беларусь"] },
      { type: "finish", titleRu: "Урок завершён", titleBe: "Урок завершаны" },
    ],
  },
  {
    ...
    tasks: [
      {
        ...
        theoryRu:
          "Попробуй произнести: Прывітанне! Мяне завуць Аляксей. Я з Расіі. Я праграміст. Вучу беларускую мову. Прыемна пазнаёміцца!",
        theoryBe:
          "Паспрабуй вымавіць: Прывітанне! Мяне завуць Аляксей. Я з Расіі. Я праграміст. Вучу беларускую мову. Прыемна пазнаёміцца!",
      },
